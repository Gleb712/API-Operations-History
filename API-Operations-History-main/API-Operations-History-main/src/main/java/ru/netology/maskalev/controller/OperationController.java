package ru.netology.maskalev.controller;

import lombok.RequiredArgsConstructor;
import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import ru.netology.maskalev.controller.dto.CustomerDTO;
import ru.netology.maskalev.controller.dto.OperationDTO;
import ru.netology.maskalev.controller.dto.OperationsGetResponse;
...
public class OperationController {
    ...
    public List<OperationDTO> getCustomerOperations(@PathVariable int id) {
        Map<Customer, List<Operation>> statement = statementService.getStatement();
        return statement.entrySet().stream()
